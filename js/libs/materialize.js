	...
	var Autocomplete = function(_Component10) {
		...
		_createClass(Autocomplete, [{
			...
			value: function _setupDropdown() {
				...
				$(this.container).addClass('autocomplete-content dropdown-content').css("background-color", "transparent");
			...
			value: function selectOption(el) {
				...
				var tmp_val = this.el.value.split(" ");
				tmp_val[tmp_val.length - 1] = text;
				this.el.value = tmp_val.join(" ");
